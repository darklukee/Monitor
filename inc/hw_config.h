...
#define KEY_DOWN_EXTI_LINE EXTI_Line6
...
#define KEY_LEFT_EXTI_LINE EXTI_Line7
...
#define KEY_ESC_GPIO_CLK RCC_AHB1Periph_GPIOB
#define KEY_ESC_EXTI_LINE EXTI_Line4
